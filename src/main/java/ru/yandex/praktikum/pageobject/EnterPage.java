...
public class EnterPage {
    ...
    private By enterEmailField = By.xpath(".//label[text()='Email']/following-sibling::input");
    private By enterPasswordField = By.xpath(".//*[text()='Пароль']/following-sibling::input");
    private By buttonEnter = By.xpath(".//button[text()='Войти']");
    private By buttonRegister = By.xpath(".//a[text()='Зарегистрироваться']");//class = Auth_link__1fOlj
